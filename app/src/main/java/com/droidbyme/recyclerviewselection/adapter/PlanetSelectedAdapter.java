...
public class PlanetSelectedAdapter extends RecyclerView.Adapter<PlanetSelectedAdapter.PlanetHolder>{
    private Context context;
    private ArrayList<Planet> planets;

    public PlanetSelectedAdapter(Context context, ArrayList<Planet> planets){
    ...
    @NonNull
    @Override
    public PlanetSelectedAdapter.PlanetHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_planet, parent, false);
        return new PlanetHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PlanetSelectedAdapter.PlanetHolder planetHolder, int i) {
